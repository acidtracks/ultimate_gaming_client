...
lv_obj_t *launcher_win_create(lv_fragment_t *self, lv_obj_t *parent) {
    ...
    lv_label_set_text_static(title_label, "Ultimate Gaming Client");
    ...
    lv_btn_set_icon_font(add_btn, lv_theme_ugc_get_iconfont_small(nav));
    ...
    lv_btn_set_icon_font(help_btn, lv_theme_ugc_get_iconfont_small(nav));
    ...
    lv_btn_set_icon_font(pref_btn, lv_theme_ugc_get_iconfont_small(nav));
    ...
    lv_btn_set_icon_font(quit_btn, lv_theme_ugc_get_iconfont_small(nav));
